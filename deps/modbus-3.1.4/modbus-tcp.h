...
MODBUS_API modbus_t* modbus_new_tcp_lm(const char *comNumber, const char *ip_address, int port);
MODBUS_API modbus_t* modbus_new_rtutcp_lm(const char *comNumber, const char *ip_address, int port);
